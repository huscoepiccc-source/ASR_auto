...
def main():
    ...
    # 在 argparse 中追加
    parser.add_argument("--summarize", action="store_true", help="完成转写后生成摘要")
    parser.add_argument("--llm-backend", type=str, default="transformers", choices=["transformers", "llama_cpp"])
    parser.add_argument("--llm-model", type=str, default=r"H:\models\Qwen2.5-3B-Instruct")  # 或 GGUF 路径
